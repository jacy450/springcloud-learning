package com.jacky.springcloud.userService.service.impl;

import com.jacky.springcloud.userService.entity.User;
import com.jacky.springcloud.userService.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public void initData() {
        ...
        userList.add(new User(1L, "root", "root"));
        userList.add(new User(2L, "andy", "root"));
        userList.add(new User(3L, "mark", "root"));
    }
}
